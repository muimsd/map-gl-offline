...
export function createDownloadProgressSection(props: DownloadProgressSectionProps): HTMLDivElement {
  ...
  for (const [regionId, progress] of downloads) {
    ...
    progressCard.className = 'p-4 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-sm';
  ...
  sectionCard.className = 'p-6 bg-gradient-to-br from-blue-50 to-white dark:from-blue-900/20 dark:to-gray-800 border border-blue-200 dark:border-blue-700 rounded-lg shadow-sm mb-6';
